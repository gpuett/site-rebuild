...
export class EditorPicksComponent {
  ...
  editorMedia: Media[] = [
    ...
    new Media("TULLY","Jason Reitman re-teams with his Juno screenwriter Diablo Cody for a new film that ranks among the director's best.",'./../assets/tully.jpg','./../assets/favorable.png',"76"),
